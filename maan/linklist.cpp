    ...
    public:
        ...
        void addAtAnyPosition(int data, int pos) {
            ...
            if(this->head == NULL || this->count == 0){
                ...
                newNode->next = temp->next; // taking backup of next node in the list
                temp->next = newNode; // changing the link between nodes 
                this->count++;
            }
        }
        ...
        void updateAtAnyPosition(int data, int pos = 1) {
            Node *temp = this->head;
